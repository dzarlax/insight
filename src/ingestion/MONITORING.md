...
|--------|---------|------------|
| `pass` | MAX(`_airbyte_extracted_at`) within last 30h | Nothing |
| `warn` | 30–48h lag (one missed run) | Investigate during business hours |
| `error` | >48h lag (multiple missed runs) | Page |
...
```json
{
  ...
  "summary": "3 bronze source(s) breaching freshness SLA",
  "breaches": [
    {
